...
import es.upm.muss.agile.service.MailEngine;
import es.upm.muss.agile.service.UserExistsException;
import es.upm.muss.agile.service.UserManager;
import es.upm.muss.agile.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "es.upm.muss.agile.service.UserService")
