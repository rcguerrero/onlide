...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see es.upm.muss.agile.service.impl.PasswordTokenManager#generateRecoveryToken(es.upm.muss.agile.model.User)
     */
    @Override
    ...
    /**
     * @see es.upm.muss.agile.service.impl.PasswordTokenManager#isRecoveryTokenValid(es.upm.muss.agile.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see es.upm.muss.agile.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
